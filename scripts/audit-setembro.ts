/**
 * Auditoria e Importação de Lançamentos Setembro 2025
 * Executar: npx tsx scripts/audit-setembro.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_setembro.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_setembro_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA SETEMBRO 2025');
