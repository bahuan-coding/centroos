...
import { useTituloWizard, Warning } from './TituloWizardProvider';
import { cn } from '@/lib/utils';

export function TituloPendenciasPanel() {
  const { warnings, goToStep, focusField, steps } = useTituloWizard();
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-amber-700 mt-0.5">
            O título pode ser criado, mas recomendamos verificar estes pontos.
          </p>
