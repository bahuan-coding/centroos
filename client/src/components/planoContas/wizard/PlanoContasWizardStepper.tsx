...
export function PlanoContasWizardStepper() {
  const { steps, currentStep, goToStep, warnings } = usePlanoContasWizard();
      ...
      <nav className="hidden lg:flex flex-col w-64 shrink-0 bg-zinc-900 text-zinc-100" aria-label="Progresso do cadastro">
        ...
        <div className="p-4 border-t border-zinc-800">
          <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/20">
            <p className="text-[10px] text-violet-300 uppercase tracking-wider font-medium">Norma</p>
            <p className="text-xs text-zinc-400 mt-1">ITG 2002 (R1) — Plano de Contas para entidades sem fins lucrativos</p>
          </div>
        </div>
      </nav>
