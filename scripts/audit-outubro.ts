/**
 * Auditoria e Importação de Lançamentos Outubro 2025
 * Executar: npx tsx scripts/audit-outubro.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_outubro.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_outubro_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA OUTUBRO 2025');
