/**
 * Auditoria e Importação de Lançamentos Dezembro 2024
 * Executar: npx tsx scripts/audit-dezembro.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_dezembro.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_dezembro_2024';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA DEZEMBRO 2024');
