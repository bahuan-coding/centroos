/**
 * Auditoria e Importação de Lançamentos Agosto 2025
 * Executar: npx tsx scripts/audit-agosto.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_agosto.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_agosto_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA AGOSTO 2025');
