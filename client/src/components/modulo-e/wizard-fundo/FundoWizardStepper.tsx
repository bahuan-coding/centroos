...
export function FundoWizardStepper() {
  const { steps, currentStep, goToStep, warnings } = useFundoWizard();
              ...
              <div key={step.id} className="relative">
                ...
                >
                  <span className={cn(
                    ...
                    status === 'current' && "bg-gradient-to-br from-teal-500 to-teal-600 text-white shadow-lg shadow-teal-500/25",
