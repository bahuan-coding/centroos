/**
 * Auditoria e Importação de Lançamentos Julho 2025
 * Executar: npx tsx scripts/audit-julho.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_julho.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_julho_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA JULHO 2025');
