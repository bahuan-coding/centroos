/**
 * Auditoria e Importação de Lançamentos Fevereiro 2025
 * Executar: npx tsx scripts/audit-fevereiro.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_fevereiro.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_fevereiro_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA FEVEREIRO 2025');
