/**
 * Auditoria e Importação de Lançamentos Novembro 2025
 * Executar: npx tsx scripts/audit-novembro.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_novembro.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_novembro_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA NOVEMBRO 2025');
