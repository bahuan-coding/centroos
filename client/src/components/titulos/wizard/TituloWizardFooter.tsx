...
interface TituloWizardFooterProps {
  onSubmit: () => void;
}

export function TituloWizardFooter({ onSubmit }: TituloWizardFooterProps) {
  const { currentStep, totalSteps, goBack, goNext, isDirty, saveDraft, isSaving, isSubmitting, form } = useTituloWizard();
