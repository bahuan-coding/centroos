...
import { 
  CentroWizardProvider, 
  useCentroWizard,
  CentroFormData 
} from './wizard-centro/CentroWizardProvider';
import { CentroWizardHeader } from './wizard-centro/CentroWizardHeader';
import { CentroWizardFooter } from './wizard-centro/CentroWizardFooter';
import { CentroWizardStepper } from './wizard-centro/CentroWizardStepper';
import { RascunhoBanner } from './wizard-centro/RascunhoBanner';
import { StepIdentificacao, StepDetalhes, StepRevisao } from './wizard-centro/steps';
...
function WizardContent({ onClose, onSuccess }: { onClose: () => void; onSuccess?: () => void }) {
  const { currentStep, steps, isDirty, submit, saveDraft } = useCentroWizard();
  ...
  return (
    <>
      <div className="flex flex-col h-full bg-white">
        <CentroWizardHeader onClose={handleClose} />
        ...
        <CentroWizardFooter onSubmit={handleSubmit} />
      </div>
