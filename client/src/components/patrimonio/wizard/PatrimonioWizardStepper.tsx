...
export function PatrimonioWizardStepper() {
  const { steps, currentStep, goToStep, warnings } = usePatrimonioWizard();
              ...
              <div key={step.id} className="relative">
                ...
                >
                  <span className={cn(
                    ...
                    status === 'current' && "bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg shadow-blue-500/25",
