...
export function CentroWizardStepper() {
  const { steps, currentStep, goToStep, warnings } = useCentroWizard();
              ...
              <div key={step.id} className="relative">
                ...
                >
                  <span className={cn(
                    ...
                    status === 'current' && "bg-gradient-to-br from-slate-500 to-slate-600 text-white shadow-lg shadow-slate-500/25",
