/**
 * Auditoria e Importação de Lançamentos Março 2025
 * Executar: npx tsx scripts/audit-marco.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_marco.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_marco_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA MARÇO 2025');
