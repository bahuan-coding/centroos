/**
 * Auditoria e Importação de Lançamentos Abril 2025
 * Executar: npx tsx scripts/audit-abril.ts
 */
...
const RAWDATA_PATH = path.join(__dirname, '..', 'rawdata', 'rawdata_abril.csv');
const IMPORT_BATCH_ID = crypto.randomUUID();
const SOURCE_SYSTEM = 'rawdata_abril_2025';
...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('  AUDITORIA ABRIL 2025');
