...
export function TituloWizardStepper() {
  const { steps, currentStep, goToStep, warnings, form } = useTituloWizard();
  
  const accentColor = form.tipo === 'receber' ? 'emerald' : 'rose';
              ...
              <div key={step.id} className="relative">
                ...
                >
                  <span className={cn(
                    ...
                    status === 'current' && accentColor === 'emerald' && "bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg shadow-emerald-500/25",
                    status === 'current' && accentColor === 'rose' && "bg-gradient-to-br from-rose-500 to-rose-600 text-white shadow-lg shadow-rose-500/25",
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  status === 'current' && accentColor === 'emerald' && "bg-emerald-600",
                  status === 'current' && accentColor === 'rose' && "bg-rose-600",
