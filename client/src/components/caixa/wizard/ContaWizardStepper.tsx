...
export function ContaWizardStepper() {
  const { steps, currentStep, goToStep, warnings } = useContaWizard();
  ...
  return (
    <>
      ...
      <nav 
        className="hidden lg:flex flex-col w-64 shrink-0 bg-zinc-900 text-zinc-100" 
              ...
              <div key={step.id} className="relative">
                ...
                >
                  <span className={cn(
                    ...
                    status === 'current' && "bg-gradient-to-br from-violet-500 to-indigo-600 text-white shadow-lg shadow-violet-500/25",
                    ...
                    {(status === 'current' || status === 'pending') && <span>{step.icon}</span>}
                  </span>
